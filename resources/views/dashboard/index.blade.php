            ...
            <div class="row no-gutters align-items-center">
              <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                              To do List</div>
                            @if ($todo['checkout'] == 0)
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Tidak ada Order Atau Survey yang masuk
                            </div>
                            @else
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><a
                                href="{{ url('/dashboard/confirmation') }}">{{ $todo['checkout'] }} Pesanan menunggu
                                dikonfirmasi.</a></div>
                            @endif
                          </div>
                          <div class="col-auto">
                ...
                <div class="row">
                      ...
                      <div class="card-body">
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                              <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $categories_count }}
                                  Categories</div>
                              </div>
                            </div>
                          </div>
                  ...
                  <<<<<<< HEAD <!-- Pending Requests Card Example -->
                    <div class="col-xl-3 col-md-6 mb-4">
                                  ...
                                  <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                          Total Order</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $orders_count }} Orders
                                        </div>
                                      </div>
                                      <div class="col-auto">
                                        <i class="fa fa-clipboard-list fa-2x text-gray-300"></i>
                                      </div>
                                      >>>>>>> e7175950e844853a35dfe2fadab9476984dcb55c
                                    </div>
                                  </div>
                                </div>
                              </div>
