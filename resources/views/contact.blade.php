...
<div class="container">
    <div class="row">
        <div class="col-lg-6 py-4 mb-3">
            ...
            <small class="p-0 m-0">*Lokasi Showroom</small>
        </div>
        <div class="col-lg-6">
            <h2 class="py-4">Lokasi Kami</h2>
            <div class="row">
                <div class="col-sm-6 table-responsive">
                    ...
                    <table class="table table-sm">
                        <tr>
                            <td>Alamat</td>
                            <td>: Mutiara Citramas No. A-10 (Tidar), Malang, Jawa Timur</td>
                        </tr>
                        <tr>
                            <td>Telepon</td>
                            <td>: 0852 4926 4100</td>
                        </tr>
                    </table>
                </div>
                <div class="col-sm-6 table-responsive">
                    ...
                    <table class="table table-sm">
                        <tr>
                            <td>Alamat</td>
                            <td>: Mall Olympic Garder GFS 39-40, Malang, Jawa Timur</td>
                        </tr>
                        <tr>
                            <td>Telepon</td>
                            <td>: 0852 4926 4100</td>
    ...
    <div class="row">
        <div class="col-md-3 mt-2">
            ...
            <table class="table table-sm">
                <tr>
                    <td><i class="bi bi-envelope" style="font-size: 1em;"></i> omega.artmalang@gmail.com</td>
                </tr>
                <tr>
                    <td><i class="bi bi-telephone" style="font-size: 1em;"></i> 0852 4926 4100</td>
                </tr>
                <tr>
