...
@section('container')
  ...
  <div class="container">
    ...
    @endif
    <form action="{{ route('checkout.payment', $id_checkout) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
      @method('patch')
      @csrf()
      <div class="row pr-4">
        ...
        <div class="col-6" style="background: #f8f8f8; height: 100%">
          ...
          <div class="m-4">
            ...
            <div class="payment-options">
              ...
              <div class="my-3">
                <input type="radio" name="payment" value="bank_transfer" class="mr-2"> Bank Transfer
              </div>
              <div class="my-3">
